...
├────────────────────────────────────────────────────────────┤
│                    Core Libraries                          │
│    (React, Vite, Redux, Tailwind, Chart Libraries)        │
└────────────────────────────────────────────────────────────┘
```
...
- **Framework**: React 19.2 + Vite 7.2 (Lightning-fast development)
...
- **Server State**: React Query/TanStack Query (^5.90.16)
...
- **Component Library**: Lucide React (^0.562.0) - 600+ SVG icons
- **Carousel**: Embla Carousel React (^8.6.0)
- **Class Variance**: class-variance-authority (^0.7.1)

### Data Visualization & Reporting

- **Charts & Graphs**: Recharts (^3.6.0) - React charts library
...
- **CSS Processing**:
  ...
  - Tailwind CSS vite plugin (@tailwindcss/vite ^4.1.18)
- **Type Definitions**:
  - @types/react (^19.2.5)
...
- **Fast Refresh**: React Refresh plugin
...
| **Core**      | react-dom             | ^19.2.0  | DOM rendering       |
| **Routing**   | react-router-dom      | ^7.12.0  | Client-side routing |
| **State**     | @reduxjs/toolkit      | ^2.11.2  | State management    |
| **State**     | react-redux           | ^9.2.0   | Redux bindings      |
| **Data**      | @tanstack/react-query | ^5.90.16 | Server state        |
| **HTTP**      | axios                 | ^1.13.2  | API calls           |
...
| **UI**        | lucide-react          | ^0.562.0 | Icons               |
| **Export**    | jspdf                 | ^4.0.0   | PDF export          |
| **Export**    | jspdf                 | ^4.0.0   | PDF export          |
| **Export**    | html2canvas           | ^1.4.1   | Screenshot          |
...
```json
{
  "name": "newscope-analytics-frontend",
  "private": true,
  "version": "0.0.0",
  "type": "module",
  "scripts": {
  ...
  "keywords": ["news", "analytics", "dashboard", "intelligence"],
  "author": "NewsScope Team",
  "license": "ISC",
  "description": "Geopolitical Intelligence Platform - Frontend"
}
```
...
- **Tailwind CSS v4**: Latest utility CSS framework with Vite plugin
...
3. **Hot Module Reload**: Changes reflect instantly
4. **Type Checking**: `tsc -b` during build

### Project Structure for Vite + React
